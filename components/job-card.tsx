...
import { AlertCircle, Bell, BellOff, ExternalLink, MoreVertical, Pencil, Trash2 } from "lucide-react"
        ...
        <div className="text-xs text-muted-foreground">
          {hasReminder && (
            <div className="flex items-center gap-1">
              ...
              <span>Reminder: {format(new Date(application.reminder as Date), "MMM d, yyyy")}</span>
            </div>
          )}
        </div>
